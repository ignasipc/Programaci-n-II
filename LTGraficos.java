...
public class LTGraficos extends JDialog {
    ...
    public LTGraficos(JFrame frame,String [] campos) {       
        ...
        for (int indice=0;indice<datos.length;indice++) {
            ...
            conceptos[indice].setFont(new Font("Arial",Font.BOLD,20));
            datos[indice]=new JTextField();
            datos[indice].setText("");
            datos[indice].setHorizontalAlignment(JTextField.RIGHT);
            datos[indice].setFont(new Font("Arial",Font.BOLD,20));
            paneles[indice]=new JPanel();
            paneles[indice].setFont(new Font("Arial",Font.BOLD,20));
        ...
        salirBoton.setFont(new Font("Arial",Font.BOLD,20));
    ...
    public String [] getDatosTexto() {
        ...
        int numeroDatos = datosIntroducidos.length;
